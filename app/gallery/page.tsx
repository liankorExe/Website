...
import { X, ChevronLeft, ChevronRight, Download, Calendar, MapPin, Users } from "lucide-react";
...
const galleryImages: GalleryImage[] = [
  {
    ...
    description: "Une magnifique construction médiévale réalisée par la communauté lors de l'événement Build Battle.",
    category: "builds",
    date: "2024-12-15",
    author: "BuildMaster",
    location: "Spawn Nord"
  },
  {
    ...
    description: "Vue panoramique depuis les montagnes du serveur, capturée au coucher du soleil.",
    category: "landscapes",
    date: "2024-12-10",
  ...
  },
  {
    ...
    description: "Grand rassemblement de la communauté pour célébrer l'anniversaire du serveur.",
    category: "events",
    date: "2024-12-01",
  ...
  },
  {
    ...
    src: "/placeholder/background_omc.png",
    title: "Ville Moderne",
    description: "Centre-ville avec ses gratte-ciels et son architecture contemporaine.",
    category: "builds", 
    date: "2024-11-28",
    author: "CityBuilder",
  ...
  },
  {
    ...
    description: "Spectacle de feux d'artifice lors du festival annuel des lumières.",
    category: "events",
    date: "2024-11-20",
    author: "FestivalTeam",
    participants: 67
  },
  {
    ...
    src: "/placeholder/background_omc.png",
    title: "Base Spatiale",
    description: "Complexe spatial futuriste avec station de lancement et laboratoires.",
    category: "builds",
    date: "2024-11-15",
        ...
        <div className="max-w-6xl mx-auto px-4 py-16">
          ...
          >
            ...
            <p className="text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto">
              Découvrez les plus belles créations, événements et moments de notre communauté Minecraft
            </p>
          </motion.div>
        </div>
      </div>
              ...
              >
                <Card className="overflow-hidden border-border/50 hover:border-primary/50 transition-all duration-300 hover:shadow-lg py-0">
                  ...
                  <CardContent className="p-4">
                    <Badge
                      className={`${getCategoryColor(image.category)} mb-2 w-fit`}
                    >
                      {categories.find(cat => cat.key === image.category)?.icon} {categories.find(cat => cat.key === image.category)?.label}
                    </Badge>
            ...
            >
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-2">
                    <Badge className={getCategoryColor(selectedImage.category)}>
                      {categories.find(cat => cat.key === selectedImage.category)?.icon} {categories.find(cat => cat.key === selectedImage.category)?.label}
                    </Badge>
                  </div>
                  <div className="flex items-center gap-2">
                    ...
                    <Button size="icon" variant="ghost" onClick={closeModal} className="text-white hover:bg-white/20">
                      <X className="w-4 h-4" />
                    </Button>
                  </div>
                </div>
              ...
              <div className="p-6">
                ...
                <div className="flex flex-wrap gap-4 text-sm text-muted-foreground">
                  ...
                  <div>
                    <span className="font-medium">Par @{selectedImage.author}</span>
                  </div>
