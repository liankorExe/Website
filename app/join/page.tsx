    ...
    <div className="min-h-screen bg-background">
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              ...
              target="_blank"
              className="bg-[#5865F2] hover:bg-[#5865F2]/90 text-white px-6 py-3 rounded-lg font-medium transition-colors flex items-center justify-center"
            >
              <svg
      ...
      <footer className="border-t bg-muted/50 mt-20">
        <div className="container mx-auto px-4 py-12">
          <div className="grid md:grid-cols-3 gap-8">
            <div>
              <div className="flex items-center space-x-2 mb-4">
                <Image src={Logo} alt="OpenMC Logo" width={32} height={32} />
                <span className="font-bold">OpenMC</span>
              </div>
              <p className="text-muted-foreground">
          ...
          <div className="border-t mt-8 pt-8 flex flex-col sm:flex-row justify-between items-center text-muted-foreground">
